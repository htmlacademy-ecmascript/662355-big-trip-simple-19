  ...
  <div class="trip-controls__filters">
    ...
    <form class="trip-filters" action="#" method="get">
      <div class="trip-filters__filter">
        <input id="filter-everything" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="${FilterType.ALL}" ${filterType === FilterType.ALL ? 'checked' : ''}>
...
export default class FilterView extends AbstractView {
  ...
  constructor({ onChange, filterType }) {
    super();
